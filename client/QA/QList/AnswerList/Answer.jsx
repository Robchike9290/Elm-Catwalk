          ...
          return (
			...
			<div className="answer_info">
				<div id="leftA">
					...
					{dateFormat(answer.date, "dddd, mmmm dS, yyyy")} | Helpful?{" "}
					<u onClick={toggleAhelpful}>Yes</u> ({helpfulness}) |{" "}
					<u onClick={toggleReport}>{Areport}</u>
				</div>
			</div>
			{togglePicture && (
				<PicturePopUp
					currentPicture={currentPicture}
					changeTogglePicture={changeTogglePicture}
				/>
			)}
		</div>
	);
